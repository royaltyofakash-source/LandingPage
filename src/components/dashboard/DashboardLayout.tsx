...
import { LayoutDashboard, Users, Settings, LogOut, Activity, BarChart3, Table2 } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="fixed inset-y-0 left-0 z-50 w-64 border-r border-border bg-card/50 backdrop-blur-xl">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-border">
          <Link to="/" className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground hover:bg-accent hover:text-destructive transition-colors">
      ...
      {/* Main Content */}
      <main className="ml-64 flex-1 flex flex-col min-h-screen min-w-0">
        {/* Header */}
